   ...
   <Container fluid>
      ...
      <Row className="justify-content-center align-items-center">
        <Col xs={12} sm={6} lg={4} className="text-center">
          <img src="/shawn.gif" alt="Image 1" className="img-fluid mb-4" />
          <h2>Step 1:</h2>
          <p>Create an account with your email.</p>
        </Col>
        <Col xs={12} sm={6} lg={4} className="text-center">
          <img src="/soccer-leagues.jpg" alt="Image 2" className="img-fluid mb-4" />
          <h2>Step 2:</h2>
      ...
      <Row className="justify-content-center align-items-center">
        <Col xs={12} sm={6} lg={4} className="text-center">
          ...
          <p>Click the league you want to enter and select the add button to join!</p>
        </Col>
        <Col xs={12} sm={6} lg={4} className="text-center">
