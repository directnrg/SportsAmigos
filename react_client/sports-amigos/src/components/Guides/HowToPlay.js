...
export default function HowToPlay() {
  return (
    //It returns the How to Play page with React-Bootstrap
    <>
      <Container fluid>
        ...
        <Row className="justify-content-center align-items-center">
          ...
          <Col xs={12} sm={6} lg={4} className="text-center">
            <Image
              src="/soccer-leagues.jpg"
              alt="Image 2"
              className="img-fluid mb-4"
            />
            <h2>Step 2:</h2>
            <p>
              You're in! Checkout the list of Leagues available to you or create
              your own.
            </p>
          </Col>
        </Row>
        ...
        <Row className="justify-content-center align-items-center text-center">
          <Col xs={12} sm={6} lg={4} className="text-center">
            ...
            <p>
              Select the result of each game on the weekly pool.{" "}
              <strong>REMEMBER</strong>, your decision will be final!
            </p>
          </Col>
        </Row>
        <Row className="justify-content-center align-items-center text-center">
